...
class TestCases(unittest.TestCase):
   ...
   def test_earthquakes_equal_2(self):
      quake1 = Earthquake('26km NE of San Francisco, CA', 0.97, -175.3845, 24.57372, 195737573)
      quake2 = Earthquake('26km NE of San Francisco, CA', 0.97, -175.3845, 24.57372, 195737573)
      self.assertEqual(quake1, quake2)
